...
- Mark tasks completed with vulnerability summary (critical/high/medium/low counts)
- Message the code author directly if you find CRITICAL vulnerabilities
- Message architect when security issues require architectural changes
- Share security review report with the lead
