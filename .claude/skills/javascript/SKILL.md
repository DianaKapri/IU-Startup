---
name: javascript
description: Use when building, optimizing, or refactoring modern JavaScript code for browser, Node.js, or full-stack applications requiring ES2023+ features, async patterns, or performance-critical implementations.
