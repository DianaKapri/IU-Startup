...
/* ═══ Демо-данные — 21 класс ═══ */
var DEM={
  '5А':[['мат','рус','ист','ия','био','фк','техн'],['лит','мат','рус','геогр','муз','обж',''],['мат','ия','рус','био','инф','ист',''],['рус','мат','лит','фк','техн','',''],['ия','мат','рус','общ','изо','','']],
  '5Б':[['рус','мат','ия','лит','фк','обж'],['мат','рус','био','ист','техн','муз'],['ия','мат','рус','геогр','изо',''],['рус','мат','инф','общ','лит','фк'],['мат','ия','рус','био','ист','']],
  '5В':[['лит','мат','рус','ия','фк',''],['рус','мат','био','ист','техн','обж'],['муз','лит','рус','изо','фк',''],['мат','ия','рус','инф','геогр','общ'],['ия','мат','рус','био','ист','']],
  '6А':[['мат','рус','ия','лит','био','фк'],['рус','мат','ист','общ','техн','муз'],['изо','лит','фк','обж','муз',''],['мат','ия','рус','инф','геогр','био'],['ия','мат','рус','ист','техн','']],
  '6Б':[['лит','мат','рус','муз','фк',''],['рус','мат','ия','ист','техн','обж'],['мат','ия','рус','инф','био','общ'],['мат','рус','лит','геогр','изо','фк'],['ия','мат','рус','био','ист','техн']],
  '6В':[['лит','мат','рус','ия','ист','фк'],['рус','мат','био','общ','техн','муз'],['изо','лит','обж','фк','геогр',''],['мат','ия','рус','инф','био','ист'],['ия','мат','рус','лит','техн','']],
  ...
  '7Б':[['лит','алг','рус','ия','био','обж',''],['рус','гео','физ','ист','техн','муз','фк'],['ия','лит','геогр','изо','фк','',''],['алг','рус','ия','физ','общ','инф','мхк'],['гео','рус','алг','био','ист','техн','']],
  '7В':[['лит','алг','муз','фк','','',''],['рус','гео','физ','ия','био','техн','обж'],['алг','рус','ия','ист','геогр','мхк',''],['рус','гео','физ','общ','лит','инф','фк'],['алг','ия','рус','био','ист','техн','изо']],
  ...
  '8Б':[['лит','алг','рус','ия','био','обж',''],['рус','гео','физ','хим','ист','общ','фк'],['ия','лит','геогр','черч','муз','фк',''],['алг','хим','рус','ия','инф','био','ист'],['гео','физ','алг','рус','лит','техн','']],
  '8В':[['лит','алг','рус','ия','ист','фк',''],['рус','гео','физ','хим','общ','техн','обж'],['ия','лит','муз','геогр','черч','фк',''],['алг','хим','рус','ия','био','инф','ист'],['гео','физ','алг','рус','лит','био','']],
  ...
  '9Б':[['лит','алг','рус','ия','ист','фк',''],['рус','гео','физ','хим','био','общ','обж'],['ия','лит','геогр','инф','фк','',''],['алг','рус','хим','ия','ист','техн','лит'],['гео','физ','алг','рус','био','общ','']],
  '9В':[['алг','рус','физ','ия','ист','био','обж'],['гео','хим','рус','лит','общ','инф','фк'],['алг','ия','рус','физ','геогр','лит','техн'],['хим','гео','ия','алг','ист','био','фк'],['рус','алг','лит','общ','техн','черч','изо']],
  '10А':[['лит','алг','рус','ия','био','обж',''],['гео','хим','рус','ист','общ','фк',''],['ия','лит','геогр','инф','фк','',''],['алг','рус','хим','ия','био','ист','физ'],['гео','физ','алг','лит','общ','мхк','']],
  '10Б':[['лит','алг','рус','ия','ист','обж',''],['рус','гео','физ','хим','общ','фк',''],['ия','лит','геогр','мхк','фк','',''],['алг','хим','рус','ия','био','инф','ист'],['гео','физ','алг','лит','био','общ','']],
  '10В':[['рус','алг','хим','ия','лит','обж',''],['гео','физ','рус','био','ист','общ',''],['ия','алг','лит','геогр','фк','',''],['алг','хим','рус','ия','инф','мхк','фк'],['гео','физ','алг','лит','био','ист','']],
  ...
  '11Б':[['лит','алг','рус','ия','ист','обж',''],['рус','гео','физ','хим','общ','фк',''],['ия','лит','мхк','инф','фк','',''],['алг','хим','рус','ия','био','геогр','ист'],['гео','физ','алг','лит','био','общ','']],
  '11В':[['лит','ия','мхк','фк','','',''],['рус','гео','физ','хим','общ','обж',''],['алг','рус','ия','ист','био','инф',''],['алг','хим','рус','ия','био','геогр','фк'],['гео','физ','алг','рус','ист','лит','общ']]
};
