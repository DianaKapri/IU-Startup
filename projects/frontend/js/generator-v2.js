...
var V2_DIFF_5 = {
  'Математика':10,'Иностранный язык':9,'Русский язык':8,'Родной язык':8,
  'Биология':10,'Природоведение':7,'Обществознание':6,'История':5,
  'Литература':4,'Информатика':4,'Информатика и ИКТ':4,'Технология':4,
  'ИЗО':3,'Изобразительное искусство':3,'Физическая культура':3,'Физкультура':3,
  'Музыка':2,'География':7,'ОБЖ':1,'Вероятность и статистика':6
};

var V2_DIFF_6 = {
  'Математика':13,'Русский язык':12,'Родной язык':12,'Иностранный язык':11,
  'Информатика':10,'Информатика и ИКТ':10,'Обществознание':9,
  'Биология':8,'Природоведение':8,'История':8,'География':7,
  'Литература':6,'Физическая культура':4,'Физкультура':4,
  'Технология':3,'ИЗО':3,'Изобразительное искусство':3,
  'ОБЖ':2,'Музыка':1,'Вероятность и статистика':8
};

var V2_DIFF_7 = {
  'Геометрия':12,'Русский язык':11,'Родной язык':11,
  'Алгебра':10,'Иностранный язык':10,'Обществознание':9,
  'Физика':8,'МХК':8,'Биология':7,
  'История':6,'География':6,'Черчение':5,
  'Литература':4,'Информатика':4,'Информатика и ИКТ':4,
  'ОБЖ':3,'Технология':2,'Физическая культура':2,'Физкультура':2,
  'ИЗО':1,'Изобразительное искусство':1,'Музыка':1,'Вероятность и статистика':8
};

var V2_DIFF_8 = {
  'Химия':10,'Геометрия':10,'Физика':9,'Алгебра':9,
  'Иностранный язык':8,'История':8,'Русский язык':7,'Родной язык':7,
  'Биология':7,'Информатика':7,'Информатика и ИКТ':7,'Литература':7,
  'География':6,'Обществознание':5,'МХК':5,'Черчение':5,
  'ОБЖ':3,'Технология':1,
  'Физическая культура':2,'Физкультура':2,'Вероятность и статистика':8
};

var V2_DIFF_9 = {
  'Физика':13,'Химия':12,'История':10,'Иностранный язык':9,
  'Геометрия':8,'Алгебра':7,'Биология':7,'Информатика':7,'Информатика и ИКТ':7,
  'Литература':7,'Русский язык':6,'Родной язык':6,
  'География':5,'Обществознание':5,'МХК':5,
  'Технология':4,'Черчение':4,'ОБЖ':3,
  'Физическая культура':2,'Физкультура':2,'Вероятность и статистика':6
};

var V2_DIFF_1011 = {
  'Физика':12,'Геометрия':11,'Химия':11,'Алгебра':10,'Математика':10,
  'Русский язык':9,'Родной язык':9,'Литература':8,'Иностранный язык':8,
  'Биология':7,'Информатика':6,'Информатика и ИКТ':6,'Астрономия':6,
  'История':5,'Обществознание':5,'МХК':5,'Экономика':5,'Право':5,
  'География':3,'Индивидуальный проект':4,
  'ОБЖ':2,'Физическая культура':1,'Физкультура':1,
  'Вероятность и статистика':8
};
